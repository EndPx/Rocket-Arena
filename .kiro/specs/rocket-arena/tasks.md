...
- Deferred outside the active path: proximity-sensitive kickoff selection, unfinished server arena/Rapier follow-ups, swept-goal and match-outcome work, full-surface/release-gate promotion, and the separate Property 28/29 placement-bugfix path. None is a prerequisite for Tasks 6.2, 7, 8.3, 9, or 11.
