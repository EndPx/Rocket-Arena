...
- [ ] 4. Create and push the isolated audio commit
  - [-] 4.1 Build and verify an audio-only staged diff without disturbing protected dirty work
  ...
  - [~] 4.2 Commit the verified index once, push the current branch, and confirm preservation
