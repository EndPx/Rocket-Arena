...
export const SEEDED_TUNING_ENTRIES: readonly TuningEntry[] = deepFreeze([
  ...
  scalar(TUNING_IDS.ball.radius, 'Ball radius', 'm', 0.9125, 0.9125, 0.9125),
  ...
  scalar(TUNING_IDS.car.collider.length, 'Car collider length', 'm', 1.18, 0.8, 2.5, 'unverified-hypothesis'),
  scalar(TUNING_IDS.car.collider.width, 'Car collider width', 'm', 0.84, 0.5, 1.5, 'unverified-hypothesis'),
  scalar(TUNING_IDS.car.collider.height, 'Car collider height', 'm', 0.36, 0.2, 1, 'unverified-hypothesis'),
  ...
  vector(
    ...
    'm [x,y,z] x4',
    [-0.32, -0.18, -0.45, 0.32, -0.18, -0.45, -0.32, -0.18, 0.45, 0.32, -0.18, 0.45],
    [
      { min: -0.42, max: 0.42 }, { min: -0.18, max: 0.18 }, { min: -0.59, max: 0.59 },
      { min: -0.42, max: 0.42 }, { min: -0.18, max: 0.18 }, { min: -0.59, max: 0.59 },
      { min: -0.42, max: 0.42 }, { min: -0.18, max: 0.18 }, { min: -0.59, max: 0.59 },
      { min: -0.42, max: 0.42 }, { min: -0.18, max: 0.18 }, { min: -0.59, max: 0.59 },
    ],
